...
const Json = () => {
    ...
    return (
        <div>
            <Container style={{ backgroundColor: '#f8ecf6' }}>
                <h3 style={{ textAlign: 'center', margin: '40px', fontFamily: 'poppins', fontSize: '40px', color: '#5e2251', background: '#dda1d1', fontWeight: 'bold' }}>JSON PLACEHOLDER</h3>

                <div className="form-div d-flex m-4" style={{ width: '40%' }}>
                    <select className='form-select' value={value} onChange={handleSelect}>  {/*style={{color:'#d07cbe',backgroundColor:'#c256ac'}}> */}
                        {options.map(option => (
